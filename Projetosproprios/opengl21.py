...
# função para desenho
def render():
    global vao_id, quantidade_vertices, shader_program_id, quantidade_faces,id_uniform_cor_luz,camera_alvo,angulo
    ...
    # camera
    camera_visao = None
    posicao_camera = pyrr.Vector3([math.sin(math.radians(angulo))/0.5, 0.0, math.cos(math.radians(angulo))/0.5])
