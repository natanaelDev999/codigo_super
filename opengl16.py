...
# função inicial
def init():
    global vertices, vao_id, shader_program_id, faces,local_uniform_cor
    ...
    #  2-declaração de entrada e saída ou criar uniforms e variáveis
    ...
    uniform vec3 cor_sistema;
    out vec4 cor_fragmento;

    void main(){
        cor_fragmento = vec4(cor_sistema,1.0);
    }        
    '''
    ...
    local_uniform_cor = glGetUniformLocation(shader_program_id,'cor_sistema')

# função para desenho
def render():
    global vao_id, quantidade_vertices, shader_program_id, quantidade_faces, local_uniform_cor
    ...
    glUniform3f(local_uniform_cor, # local do uniform
                0,1,0 # código RGB
                )
